  ...
  module Event
    ...
    class Event < EventBase
      ...
      def initialize(impl, number)
        ...
        get_context(:pn_event_attachments)
        @dict[:type] = EventType.by_type(number)
      end
      ...
      # Returns the Sender, or nil if there is no Link, associated associated
      # with this even if that link is a sender.
      #
