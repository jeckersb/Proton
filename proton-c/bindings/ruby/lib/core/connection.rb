...
module Qpid::Proton
  ...
  class Connection < Endpoint
    ...
    proton_attr :offered_capabilities
    proton_attr :desired_capabilities
    proton_attr :properties
    proton_attr :collector
    ...
    def initialize(impl = nil)
      @overrides = nil
      @impl = impl || Cproton.pn_connection
    ...
    # Returns the associationed Collector.
    #
    # @return [Event::Collector] The collector.
    #
    def collector
      self.collector
    end
    ...
    def container=(name)
      Cproton.pn_connect_set_container(@impl, name)
    end
    ...
    #
    def open
      object_to_data(self.offered_capabilities,
                     Cproton.pn_connection_offered_capabilities(@impl))
      object_to_data(self.desired_capabilities,
                     Cproton.pn_connection_desired_capabilities(@impl))
      object_to_data(self.properties,
